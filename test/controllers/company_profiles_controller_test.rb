...
class CompanyProfilesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create company_profile" do
    assert_difference('CompanyProfile.count') do
      post company_profiles_url, params: { company_profile: { description: @company_profile.description, name: @company_profile.name, skills: @company_profile.skills } }
    end
  ...
  test "should update company_profile" do
    patch company_profile_url(@company_profile), params: { company_profile: { description: @company_profile.description, name: @company_profile.name, skills: @company_profile.skills } }
