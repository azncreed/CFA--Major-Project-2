...
class AppliesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create apply" do
    assert_difference('Apply.count') do
      post applies_url, params: { apply: { comments: @apply.comments, email: @apply.email, name: @apply.name, phone: @apply.phone, user_id: @apply.user_id } }
    end
  ...
  test "should update apply" do
    patch apply_url(@apply), params: { apply: { comments: @apply.comments, email: @apply.email, name: @apply.name, phone: @apply.phone, user_id: @apply.user_id } }
